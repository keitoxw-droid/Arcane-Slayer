--[[
    ╔═══════════════════════════════════════════════════════════╗
    ║       HD ADMIN ARCANE (PIXEL ABSOLUTE v7.1)         ║
    ║   "La perfection est dans la fidélité absolue."          ║
    ╚═══════════════════════════════════════════════════════════╝
    
    Opération : Sovereign Prestige (v17.1) - PIXEL ABSOLUTE
    Fix : Total Reconstruction, 1:1 Header Buttons, X=180 Offset
]]
...
ScreenGui.Name = "HDAdmin_Absolute_v17_1"; ScreenGui.ResetOnSpawn = false; ScreenGui.DisplayOrder = 100000
local p = (gethui and gethui()) or (pcall(function() return CoreGui end) and CoreGui) or L:WaitForChild("PlayerGui")
ScreenGui.Parent = p

-- BOUTON "HD" (30x30 - OFFSET POUR EVITER LE CHAT)
local HDButton = Instance.new("TextButton", ScreenGui)
HDButton.Name = "HDButton"
HDButton.Size = UDim2.new(0, 30, 0, 30)
HDButton.Position = UDim2.new(0, 180, 0, 4) -- Position décalée à droite pour plus de visibilité sans gêner le chat
...
CmdWindow.Size = UDim2.new(0, 320, 0, 400)
CmdWindow.Position = UDim2.new(0.5, -160, 0.5, -200)
...
Header.Size = UDim2.new(1, 0, 0, 32); Header.BackgroundColor3 = THEME.Header; Header.ZIndex = 1001
Instance.new("UICorner", Header).CornerRadius = UDim.new(0, 4)
local HeaderFill = Instance.new("Frame", Header); HeaderFill.Size = UDim2.new(1, 0, 0.5, 0); HeaderFill.Position = UDim2.new(0, 0, 0.5, 0); HeaderFill.BackgroundColor3 = THEME.Header; HeaderFill.BorderSizePixel = 0

-- Header Buttons
local LeftBtn = Instance.new("TextButton", Header); LeftBtn.Size = UDim2.new(0, 32, 0, 32); LeftBtn.Position = UDim2.new(0, 0, 0, 0); LeftBtn.BackgroundTransparency = 1; LeftBtn.Text = "<"; LeftBtn.TextColor3 = THEME.TextWhite; LeftBtn.Font = Enum.Font.GothamBold; LeftBtn.TextSize = 12; LeftBtn.ZIndex = 1002
local MiniBtn = Instance.new("TextButton", Header); MiniBtn.Size = UDim2.new(0, 32, 0, 32); MiniBtn.Position = UDim2.new(1, -64, 0, 0); MiniBtn.BackgroundTransparency = 1; MiniBtn.Text = "-"; MiniBtn.TextColor3 = THEME.TextWhite; MiniBtn.Font = Enum.Font.GothamBold; MiniBtn.TextSize = 14; MiniBtn.ZIndex = 1002
local CloseBtn = Instance.new("TextButton", Header); CloseBtn.Size = UDim2.new(0, 32, 0, 32); CloseBtn.Position = UDim2.new(1, -32, 0, 0); CloseBtn.BackgroundTransparency = 1; CloseBtn.Text = "X"; CloseBtn.TextColor3 = THEME.TextWhite; CloseBtn.Font = Enum.Font.GothamBold; CloseBtn.TextSize = 13; CloseBtn.ZIndex = 1002
CloseBtn.MouseButton1Click:Connect(function() CmdWindow.Visible = false end)

local Title = Instance.new("TextLabel", Header); Title.Size = UDim2.new(1, -100, 1, 0); Title.Position = UDim2.new(0, 50, 0, 0); Title.BackgroundTransparency = 1; Title.Text = "COMMANDS"; Title.TextColor3 = THEME.TextWhite; Title.Font = Enum.Font.GothamBold; Title.TextSize = 13; Title.ZIndex = 1002

-- SUB HEADER (1:1 Navigation)
...
local SubLeft = Instance.new("TextLabel", SubH); SubLeft.Size = UDim2.new(0, 26, 1, 0); SubLeft.BackgroundTransparency = 1; SubLeft.Text = "<"; SubLeft.TextColor3 = THEME.TextWhite; SubLeft.Font = Enum.Font.GothamBold; SubLeft.TextSize = 10; SubLeft.ZIndex = 1002
local SubRight = Instance.new("TextLabel", SubH); SubRight.Size = UDim2.new(0, 26, 1, 0); SubRight.Position = UDim2.new(1, -26, 0, 0); SubRight.BackgroundTransparency = 1; SubRight.Text = ">"; SubRight.TextColor3 = THEME.TextWhite; SubRight.Font = Enum.Font.GothamBold; SubRight.TextSize = 10; SubRight.ZIndex = 1002
local SubT = Instance.new("TextLabel", SubH); SubT.Size = UDim2.new(1, -60, 1, 0); SubT.Position = UDim2.new(0, 30, 0, 0); SubT.BackgroundTransparency = 1; SubT.Text = "COMMANDS"; SubT.TextColor3 = THEME.TextWhite; SubT.Font = Enum.Font.GothamBold; SubT.TextSize = 11; SubT.ZIndex = 1002

-- SEARCH BAR
local Search = Instance.new("TextBox", CmdWindow); Search.Size = UDim2.new(1, -10, 0, 26); Search.Position = UDim2.new(0, 5, 0, 62); Search.BackgroundColor3 = Color3.fromRGB(24, 24, 26); Search.TextColor3 = THEME.TextWhite; Search.Font = Enum.Font.Gotham; Search.TextSize = 12; Search.PlaceholderText = "Search"; Search.Text = ""; Search.ZIndex = 1001
Instance.new("UICorner", Search).CornerRadius = UDim.new(0, 3)
local SIcon = Instance.new("ImageLabel", Search); SIcon.Size = UDim2.new(0, 16, 0, 16); SIcon.Position = UDim2.new(0, 6, 0.5, -8); SIcon.BackgroundTransparency = 1; SIcon.Image = "rbxassetid://6031154636"; SIcon.ImageColor3 = Color3.fromRGB(150, 150, 150); SIcon.ZIndex = 1002
...
local function Add(n, d)
    ...
    local i = Instance.new("ImageLabel", r); i.Size = UDim2.new(0, 16, 0, 16); i.Position = UDim2.new(0, 8, 0.5, -8); i.BackgroundTransparency = 1; i.Image = "rbxassetid://164453777"; i.ImageColor3 = Color3.fromRGB(160, 160, 160); i.ZIndex = 1003 -- Official Play Icon
    local l = Instance.new("TextLabel", r); l.Size = UDim2.new(1, -40, 1, 0); l.Position = UDim2.new(0, 34, 0, 0); l.BackgroundTransparency = 1; l.Text = ";" .. n .. " " .. (d or ""); l.TextColor3 = THEME.TextWhite; l.Font = Enum.Font.Gotham; l.TextSize = 12; l.TextXAlignment = Enum.TextXAlignment.Left; l.ZIndex = 1003
    local b = Instance.new("Frame", r); b.Size = UDim2.new(1, 0, 0, 1); b.Position = UDim2.new(0, 0, 1, -1); b.BackgroundColor3 = Color3.fromRGB(24, 24, 26); b.BorderSizePixel = 0; b.ZIndex = 1003
end
local CMDS = {{"shackle", "<player>"}, {"s", "<player>"}, {"void", "<player>"}, {"v", "<player>"}, {"mute", "<player>"}, {"m", "<player>"}, {"cmds", ""}, {"badge", ""}}
...
StarterGui:SetCore("SendNotification", { Title = "🔱 ARCANE PIXEL ABSOLUTE", Text = "Sovereign v17.1 Loaded successfully.", Duration = 4 })
_G.ArcaneCleanup = function() ScreenGui:Destroy(); State.Active = false end
print("🔱 ARCANE: Restoration Absolute v17.1 Chargée (1:1 UI Layout).")
